...
public class Hadlin {
    ...
    public static void main(String[] args) {
        try {
            ...
            Thread.sleep(10000);
            WebElement browserCategories = driver.findElement(By.xpath("//a[@class='dropdown-toggle hidden-xs hidden-sm ga_browse_top_cat']//span[contains(text(),'Categories')]"));
            ...
            a.pause(Duration.ofSeconds(4)).perform();
